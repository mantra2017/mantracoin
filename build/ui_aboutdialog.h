...
"Copyright &copy; 2011-YYYY The MantraCoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About MantraCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>MantraCoin</b> version", 0));
