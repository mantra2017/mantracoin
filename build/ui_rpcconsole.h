...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "MantraCoin - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "MantraCoin Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the MantraCoin debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the MantraCoin-Qt help message to get a list with possible MantraCoin command-line options.", 0));
#endif // QT_NO_TOOLTIP
