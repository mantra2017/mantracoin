...
// Dump addresses to peers.dat every 20 minutes (1200s)
#define DUMP_ADDRESSES_INTERVAL 1200
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MantraCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"default", "162.255.117.46"}, //First official node
    {"DNS2", "192.64.114.100"}, //second official node
    {"DNS3", "192.64.114.22"}, //second official node
    {NULL, NULL},
};

static const char *strTestNetDNSSeed[][2] = {
    {"default", "192.64.114.22"}, //First official node
    {NULL, NULL},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MantraCoin is probably already running."), addrBind.ToString().c_str());
        else
